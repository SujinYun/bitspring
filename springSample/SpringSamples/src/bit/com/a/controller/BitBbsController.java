...
//		logger.info("BitBbsController bbslist()2 ");
	...
	public String bbsdetail(BbsDto bbs, int seq, Model model) {
		...
		model.addAttribute("doc_title", bbs.getTitle());
		
		BbsDto dto = bbsService.getBbsDetail(seq);
		boolean b = bbsService.getCount(seq);
	...
	public String bbsdelete(BbsDto bbs, int seq, Model model) {
		logger.info("BitBbsController bbsdelete() " + new Date());
		logger.info("seq: " + seq);
	...
	public String bbsupdate(int seq, Model model) {
		logger.info("BitBbsController bbsupdate() " + new Date());
		logger.info("seq: " + seq);
	...
	public String bbsupdateAf(BbsDto bbs, int seq, Model model) {
		logger.info("BitBbsController bbsupdateAf() " + new Date());
		logger.info("seq: " + seq);
