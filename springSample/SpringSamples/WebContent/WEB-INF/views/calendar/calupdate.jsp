...
<tr>
	...
	<td style="padding-left: 10px">
		<input type="text" name="title" id="title" value="${calDto.title }">
	</td>	
</tr>
<%-- <tr>
...
<tr>
	...
	<td style="padding-left: 10px; padding-right: 10px">
		<textarea rows="10" cols="50" name="content" id="content">${calDto.content }</textarea>
	</td>	
</tr>
...
<input type="button" value="수정" style="background-color: #F6F6F6;" id="_updateBtn">
